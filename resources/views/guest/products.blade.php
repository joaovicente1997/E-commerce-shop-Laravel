            ...
            <div class="content">
					...
					<div class="col-sm-3">
						<div class="card" style="width: 20rem;">
						  <div class="card-body">
						  	<img src="{{ url('img/products/' . $product->image) }}" width="110" height="110" alt="">
						  	<br/>
						  	<br/>
						    <a href="{{ route('guest.show', $product->id) }}" class="card-title">{{$product->name}}</a>
                            <br/>
                            <h5>
						    <b class="card-subtitle mb-2 text-muted"> {{$product->price}}€</b>
                            </h5>
                            <br/>
                            <a href="{{ route('guest.addToCart', $product->id) }}" class="btn btn-primary">Adicionar ao Carrinho</a>
						  </div>
						</div>
						<br/><br/>
						</div>
